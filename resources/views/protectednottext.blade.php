<x-htmlhead :title="$title">
    <div class="w-full mb-3 mt-5">
        ...
        <form action="{{ route('show.files',[$info->uuid])}}" method="post" class="w-full max-w-2xl mx-auto p-3">
            @csrf
                ...
                <div class="space-y-3 bg-gray-700 p-5 rounded-2xl">
                        ...
                        <dd>
                            <ul>
                                <li class="me-1 inline-flex items-center text-sm">
                                    <span class="text-white font-semibold">{{ $info->stored_name }}</span>
                                </li>
                            </ul>
                        </dd>
                    </dl>
                        ...
                        <dd>
                            <ul>
                                <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                    <span class="text-white font-semibold">{{ is_null($info->password) ? 'No' : 'Yes' }}</span>
                                </li>
                            </ul>
                        </dd>
                    </dl>
                    ...
                    <dl class="flex flex-col sm:flex-row gap-1">
                        ...
                        <dd>
                            <ul>
                                <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                    <span class="text-white font-semibold">{{ $info->created_at }}</span>
                                </li>
                                <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                    <span class="text-white font-semibold"> | </span>
                                </li>
                                <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                    <span class="text-white font-semibold">{{ $info->created_at->diffForHumans() }}</span>
                                </li>
                            </ul>
                        </dd>
                    </dl>
                    ...
                    <dl class="flex flex-col sm:flex-row gap-1">
                        ...
                        <dd>
                            <ul>
                                @if($info->expires_at)
                                    <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                        <span class="text-white font-semibold">{{ $info->expires_at }}</span>
                                    </li>
                                    <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                        <span class="text-white font-semibold"> | </span>
                                    </li>
                                    <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                                        <span class="text-white font-semibold">{{ \Carbon\Carbon::parse($info->expires_at)->diffForHumans() }}</span>
                                    </li>
                                @else
                                    <li class="me-1 inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
